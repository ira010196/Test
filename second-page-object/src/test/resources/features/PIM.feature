Feature: Test for adding a new employee to the employee list
  ...
  Scenario Outline: Test for adding a new employee to the employee list
    ...
    Examples:
      ...
      | Alex       |             | Smith     | 11111       | 1990-11-09    | 2020-01-01          | 2021-11-11 | Basic Payment    | 40000  | Married        | Russian     | QA Engineer | Full-Time Contract  | Professionals | Quality Assurance | HQ - CA, USA         | Grade 1   | United States Dollar | Semi Monthly                   |
